...
Если Вы возвращаете обещание в своем тесте, то Вам не нужно явно завершать тест, так как он завершиться сразу после успешного выполнения обещания.
