...
Здесь содержится перевод файл [contributing.md](https://github.com/sindresorhus/ava/blob/master/contributing.md). Вот [ссылка]() если при нажатии на ссылку, Вы не можете найти файл readme.md, то можете считать что перевод актуален).
___
# Вклад в AVA
