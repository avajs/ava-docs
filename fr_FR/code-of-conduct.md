...
C'est la traduction du fichier [code-of-conduct.md](https://github.com/avajs/ava/blob/main/.github/CODE_OF_CONDUCT.md). Voici un [lien](https://github.com/avajs/ava/compare/b8bc21d9b624dd93c851c31cfb0409f537d3f2e3...main#diff-d3030a18b089fdb1fbfabf6e75e4aef0) vers les différences avec le master de AVA (Si en cliquant sur le lien, vous ne trouvez pas le fichier `code-of-conduct.md` parmi les fichiers modifiés, vous pouvez donc en déduire que la traduction est à jour).
___
